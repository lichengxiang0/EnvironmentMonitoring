...
#endif //定义是何种密度芯片（flash大小）的，Options->C/C++->define中定义为中等密度64-128K
/*  Tip: To avoid modifying this file each time you need to switch between these
        devices, you can define the device in your toolchain compiler preprocessor.

 - Low-density devices are STM32F101xx, STM32F102xx and STM32F103xx microcontrollers
   where the Flash memory density ranges between 16 and 32 Kbytes.低等密度的芯片，flash范围为16-32K
 - Low-density value line devices are STM32F100xx microcontrollers where the Flash
   memory density ranges between 16 and 32 Kbytes.
 - Medium-density devices are STM32F101xx, STM32F102xx and STM32F103xx microcontrollers
   where the Flash memory density ranges between 64 and 128 Kbytes.中等密度的芯片，flash范围为64-128K
 - Medium-density value line devices are STM32F100xx microcontrollers where the 
   Flash memory density ranges between 64 and 128 Kbytes.   
 - High-density devices are STM32F101xx and STM32F103xx microcontrollers where
   the Flash memory density ranges between 256 and 512 Kbytes.高等密度的芯片，flash范围为256-512K
 - High-density value line devices are STM32F100xx microcontrollers where the 
   Flash memory density ranges between 256 and 512 Kbytes.   
 - XL-density devices are STM32F101xx and STM32F103xx microcontrollers where
   the Flash memory density ranges between 512 and 1024 Kbytes.XL密度的芯片，flash范围为512-1024K
 ...
 * @brief Comment the line below if you will not use the peripherals drivers.
   ...
   */
  /*#define USE_STDPERIPH_DRIVER*///定义是否使用固件库的Options->C/C++->define中已经定义了
#endif
...
#ifdef USE_STDPERIPH_DRIVER	//在Options->C/C++->define中定义的，还有一个参数的定义STM32F10X_MD中等密度的芯片，flash范围为64-128K
